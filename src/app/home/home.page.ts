...
export class HomePage {
  @ViewChild('sensor1Canvas', { static: true }) sensor1Canvas: ElementRef;
  @ViewChild('sensor2Canvas', { static: true }) sensor2Canvas: ElementRef;
  @ViewChild('sensor2Graph', { static: true }) sensor2Graph: ElementRef;
  @ViewChild('sensor1Graph', { static: true }) sensor1Graph: ElementRef;
  sensor1Chart: any;
  sensor2Chart: any;
